...
PRIVATE void AVLTreeInorderApplyRec2(AVLTreeItem, ApplyFunctionGeneric,
								   void**);
PRIVATE void AVLTreePreorderApplyRec2(AVLTreeItem, ApplyFunctionGeneric,
								    void**);
PRIVATE void AVLTreePostorderApplyRec2(AVLTreeItem, ApplyFunctionGeneric,
								     void**);
...
PUBLIC void AVLTreeInorderApply2(AVLTree tree, ApplyFunctionGeneric f, 
						       void* args[]) {
	if (tree) AVLTreeInorderApplyRec2(tree->root, f, args);
}

PRIVATE void AVLTreeInorderApplyRec2(AVLTreeItem root,
								   ApplyFunctionGeneric f,
								   void* args[]) {
	if (root) {
		AVLTreeInorderApplyRec2(root->left, f, args);
		(*f)(root->element, args);
		AVLTreeInorderApplyRec2(root->right, f, args);
	}
}

PUBLIC void AVLTreePostorderApply2(AVLTree tree, ApplyFunctionGeneric f,
						   		 void* args[]) {
	if (tree) AVLTreePostorderApplyRec2(tree->root, f, args);
}

PRIVATE void AVLTreePostorderApplyRec2(AVLTreeItem root,
								   ApplyFunctionGeneric f,
								   void* args[]) {
	if (root) {
		AVLTreePostorderApplyRec2(root->left, f, args);
		AVLTreePostorderApplyRec2(root->right, f, args);
		(*f)(root->element, args);
	}
}

PUBLIC void AVLTreePreorderApply2(AVLTree tree, ApplyFunctionGeneric f,
						 		void* args[]) {
	if (tree) AVLTreePreorderApplyRec2(tree->root, f, args);
}

PRIVATE void AVLTreePreorderApplyRec2(AVLTreeItem root,
								   ApplyFunctionGeneric f,
								   void* args[]) {
	if (root) {
		(*f)(root->element, args);
		AVLTreePreorderApplyRec2(root->left, f, args);
		AVLTreePreorderApplyRec2(root->right, f, args);
	}
}
