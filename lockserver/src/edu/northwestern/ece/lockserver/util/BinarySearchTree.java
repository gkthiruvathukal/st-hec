...
/** This class demonstrates the Binary Search Tree
...
public class BinarySearchTree
  ...
  public Object find(Object target) {
    return find(root, (Comparable) target);
  }
  ...
  /** Recursive find method.
      ...
      @return The object, if found, otherwise null
   */
  private Object find(Node localRoot, Comparable target) {
    if (localRoot == null)
      return null;
  ...
  /** Starter method add.
      ...
      @param item The Comparable object being inserted
      @return true if the object is inserted, false
              if the object already exists in the tree
   */
  public boolean add(Object item) {
    root = add(root, (Comparable) item);
    return addReturn;
  }

  /** Recursive add method.
      post: The data field addReturn is set true if
            the item is added to the tree, false if the
  ...
  /** Starter method delete.
      pre:  The object being deleted must be Comparable.
  ...
  public Object delete(Object target) {
    root = delete(root, (Comparable) target);
    return deleteReturn;
  }
